<?php
include("conf.php");
$path_s=$_SESSION['path_upload'].'assets/';
$path=$_SESSION['path_upload'].'assets/uploads/';
$p=str_replace("/home/public_html","",$path);
//session_start();
...
$upload_dir = $p;//'/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $path;//str_replace('home/public_html','',$path);//'../source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $path.''; // relative path from filemanager folder to thumbs folder (with final /)
