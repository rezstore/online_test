	...
	<div class="footer">
		<div class="span_1_of_3">
			...
			<div class="footer_grid">
				<div class="foot_img">
					<img src="<?php echo get_image('home.png');?>"" alt="" />
				</div>
				<div class="foot_text">
			...
			<div class="footer_grid">
				<div class="foot_img">
					<img src="<?php echo get_image('call.png');?>" alt="" />
				</div>
				<div class="foot_text">
					<p>(416) 431-4437</p>
				</div>		
			...
			<div class="foot_nav">
				<ul>
					<li><a href="#"><img src="<?php echo get_image('soc_icon1.png');?>" alt="" /></a></li>
					<li><a href="#"><img src="<?php echo get_image('soc_icon2.png');?>" alt="" /></a></li>
					<li><a href="#"><img src="<?php echo get_image('soc_icon3.png');?>" alt="" /></a></li>
					<li><a href="#"><img src="<?php echo get_image('soc_icon4.png');?>" alt="" /></a></li>
					<div class="clear"></div>
				</ul>
		...
		<div class="span_1_of_3">
			...
			<div class="footer_grid">
				<div class="foot_img">
					<img src="<?php echo get_image('twitter.png');?>" alt="" />
				</div>
				<div class="foot_text">
